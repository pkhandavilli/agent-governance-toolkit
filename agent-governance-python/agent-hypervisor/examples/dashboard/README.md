...
Real-time visualization for multi-agent runtime supervision.
...
- **Audit & Verification** — Trust score leaderboard, audit events, verification signals
- **Event Stream** — Real-time event log, type heatmaps, causal traces

## Screenshots

The dashboard uses Plotly for interactive charts and real hypervisor data.
