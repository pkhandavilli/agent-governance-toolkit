...
"""Run the Contoso Bank loan processing MAF adapter example with native ACS."""
...
def main() -> None:
    ...
    try:
        ...
        context = kernel.create_context("loan-example")
        for prompt in ("Review the current request", 'SSN 123-45-6789'):
